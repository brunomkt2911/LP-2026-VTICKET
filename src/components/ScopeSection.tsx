      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-green-400/5 p-8 rounded-xl border border-green-400/30"
          >
        ...
        <motion.div
          ...
          className="mt-8 bg-gradient-to-r from-green-400/10 to-transparent p-6 rounded-xl border border-green-400/20"
        >
          <p className="text-gray-300 text-lg leading-relaxed">
            <span className="text-green-400 font-semibold">Nota importante:</span> Nosso foco é criar vídeos que seguram atenção e comunicam sua mensagem com clareza. Se você busca produções cinematográficas com efeitos hollywoodianos, este não é o pack ideal. Aqui você ganha volume, velocidade e resultados.
          </p>
        </motion.div>
      </div>
    </section>
